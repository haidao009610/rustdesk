...
[![NccDesk Server Pro](https://img.shields.io/badge/NccDesk%20Server%20Pro-Caracter%C3%ADsticas%20Avanzadas-blue)](https://rustdesk.com/pricing.html)
...
[**¿Cómo funciona nccdesk?**](https://github.com/rustdesk/rustdesk/wiki/How-does-NccDesk-work%3F)
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: Comunicación con [nccdesk-server](https://github.com/rustdesk/nccdesk-server), esperar la conexión remota directa ("TCP hole punching") o conexión indirecta ("relayed")
