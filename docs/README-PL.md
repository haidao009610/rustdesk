...
[![NccDesk Server Pro](https://img.shields.io/badge/NccDesk%20Server%20Pro-Zaawansowane%20Funkcje-blue)](https://rustdesk.com/pricing.html)
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: Komunikacja z [nccdesk-server](https://github.com/rustdesk/nccdesk-server), czekanie na bezpośrednie (odpytywanie TCP) lub przekazywane połączenie
