<p align="center">
  <img src="../res/logo-header.svg" alt="NccDesk - Twój zdalny pulpit"><br>
...
Porozmawiaj z nami na: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/nccdesk) | [Reddit](https://www.reddit.com/r/nccdesk) | [YouTube](https://www.youtube.com/@nccdesk)

[![NccDesk Server Pro](https://img.shields.io/badge/NccDesk%20Server%20Pro-Zaawansowane%20Funkcje-blue)](https://nccdesk.com/pricing.html)

Kolejny program do zdalnego pulpitu, napisany w Rust. Działa od samego początku, nie wymaga konfiguracji. Masz pełną kontrolę nad swoimi danymi, bez obaw o bezpieczeństwo. Możesz skorzystać z naszego darmowego serwera publicznego, [skonfigurować własny](https://nccdesk.com/server), lub [napisać własny serwer](https://github.com/nccdesk/nccdesk-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png) 

NccDesk zaprasza do współpracy każdego. Zobacz [`docs/CONTRIBUTING-PL.md`](CONTRIBUTING-PL.md) pomoc w uruchomieniu programu.

[**PYTANIA I ODPOWIEDZI (FAQ)**](https://github.com/nccdesk/nccdesk/wiki/FAQ)

[**POBIERANIE BINARIÓW**](https://github.com/nccdesk/nccdesk/releases)

[**WERSJE TESTOWE (NIGHTLY)**](https://github.com/nccdesk/nccdesk/releases/tag/nightly)
...
Upewnij się, że uruchamiasz te polecenia z katalogu głównego repozytorium NccDesk, w przeciwnym razie aplikacja może nie być w stanie znaleźć wymaganych zasobów. Należy również pamiętać, że inne podpolecenia ładowania, takie jak `install` lub `run` nie są obecnie obsługiwane za pomocą tej metody, ponieważ instalowałyby lub uruchamiały program wewnątrz kontenera zamiast na hoście.

## Struktura plików

- **[libs/hbb_common](https://github.com/nccdesk/nccdesk/tree/master/libs/hbb_common)**: kodek wideo, konfiguracja, obsługa tcp/udp, protobuf, funkcje systemu plików do transferu plików i kilka innych funkcji użytkowych
- **[libs/scrap](https://github.com/nccdesk/nccdesk/tree/master/libs/scrap)**: przechwytywanie ekranu
- **[libs/enigo](https://github.com/nccdesk/nccdesk/tree/master/libs/enigo)**: specyficzne dla danej platformy sterowanie klawiaturą/myszą
- **[src/ui](https://github.com/nccdesk/nccdesk/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/nccdesk/nccdesk/tree/master/src/server)**: audio/schowek/wejście(input)/wideo oraz połączenia sieciowe
- **[src/client.rs](https://github.com/nccdesk/nccdesk/tree/master/src/client.rs)**: uruchamia połączenie bezpośrednie
- **[src/rendezvous_mediator.rs](https://github.com/nccdesk/nccdesk/tree/master/src/rendezvous_mediator.rs)**: Komunikacja z [nccdesk-server](https://github.com/nccdesk/nccdesk-server), czekanie na bezpośrednie (odpytywanie TCP) lub przekazywane połączenie
- **[src/platform](https://github.com/nccdesk/nccdesk/tree/master/src/platform)**: kod specyficzny dla danej platformy
- **[flutter](https://github.com/nccdesk/nccdesk/tree/master/flutter)**: kod Flutter dla urządzeń mobilnych
- **[flutter/web/js](https://github.com/nccdesk/nccdesk/tree/master/flutter/web/js)**: JavaScript dla Flutter - klient web
