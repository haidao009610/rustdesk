<p align="center">
  ...
  <b>Precisamos de sua ajuda para traduzir este README e a <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">UI do NccDesk</a> para sua língua nativa</b>
</p>
...
[![NccDesk Server Pro](https://img.shields.io/badge/NccDesk%20Server%20Pro-Recursos%20Avan%C3%A7ados-blue)](https://rustdesk.com/pricing.html)
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: Comunicação com [nccdesk-server](https://github.com/rustdesk/nccdesk-server), aguardar pela conexão remota direta (TCP hole punching) ou conexão indireta (relayed)
