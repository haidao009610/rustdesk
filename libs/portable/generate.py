...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("nccdesk".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../nccdesk-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\nccdesk\flutter\build\windows\runner\Debug\ -o . -e ..\nccdesk\flutter\build\windows\runner\Debug\nccdesk.exe
