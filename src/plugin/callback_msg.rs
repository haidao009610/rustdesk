...
const MSG_TO_RUSTDESK_TARGET: &str = "nccdesk";
...
pub(super) extern "C" fn cb_msg(
    ...
    match &target as _ {
        ...
        MSG_TO_RUSTDESK_TARGET => handle_msg_to_nccdesk(id, content, len),
        _ => PluginReturn::new(
...
fn handle_msg_to_nccdesk(id: String, content: *const c_void, len: usize) -> PluginReturn {
    ...
    match &msg_to_nccdesk.r#type as &str {
        MSG_TO_RUSTDESK_SIGNATURE_VERIFICATION => request_plugin_sign(id, msg_to_nccdesk),
        t => PluginReturn::new(
            errno::ERR_CALLBACK_TARGET_TYPE,
            &format!(
