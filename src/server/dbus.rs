...
///
/// Note:
/// On linux, we use dbus to communicate multiple nccdesk process.
...
const DBUS_NAME: &str = "org.nccdesk.nccdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "NccDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.nccdesk.nccdesk /dbus org.nccdesk.nccdesk.NewConnection string:'PEER_ID'`
