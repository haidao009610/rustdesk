...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem NccDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, NccDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate NccDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate NccDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno NccDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »NccDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep NccDesk background service", "Ohrani NccDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije NccDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "NccDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "NccDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_nccdesk_password_tip", "Preveri geslo za NccDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite NccDesk, prekinite klic in program zaprite."),
        ("scam_text2", "NccDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_nccdesk_server_pro_to_{}_tip", "Prosimo, nadgradite NccDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo NccDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno NccDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri NccDesk storitvi v ozadju"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_nccdesk_client_to_{}_tip", "Prosimo, nadgradite NccDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
